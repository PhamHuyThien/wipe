...
function Attachments({ attachments }) {
    ...
    function ShowImage({ url }) {
        return (
            <div style={{ paddingBottom: "5px" }}>
                <img src={Server.API + url} style={{ width: "200px", borderRadius: "10px" }}></img>
            </div>
        );
    }
    ...
    function ShowFile({ url, name, type }) {
        return (
            <div style={{ paddingBottom: "5px" }}>
                <a href={Server.API + url} style={{ width: "200px", borderRadius: "10px", }}><u>{name + "." + type}</u></a>
            </div>
        );
    }
        ...
        return (
            <div style={{ padding: "10px", margin: "5px 0", border: "solid 1px #e3e1e1", borderRadius: "10px" }}>
                ...
                <div className="attachment">
                    <a className="material-icons" style={{ marginRight: "10px", fontSize: "20px", color: "#030401" }} href={Server.API + attachment.url}>file_download</a>
                    <div className="file">
